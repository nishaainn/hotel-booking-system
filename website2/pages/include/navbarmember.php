...
<head>
    ...
    <style>
        ...
        .dropdown-item {
            font-size: 14px;
            padding: 10px 15px;
            color: black; /* Ensure dropdown item text is black */
        }
        ...
        .dropdown-toggle::after {
            margin-left: 10px; /* Adjust arrow position */
        }
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo">
                                <a href="../index.php"><img src="../assets/img/logo/hotel.png" alt="Re' hotel logo" width="150"></a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-2 col-lg-2">
                            <!-- header-btn -->
                            <div class="dropdown">
                                <button class="btn btn-sm dropdown-toggle" type="button" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
