...
if($purpose == 'contactusweb'){
    ...
    $sql = "INSERT INTO payment(payment_id, payment_date, card_name, card_number, expirydate, cvv, payment_total) VALUES (?, ?, ?, ?, ?, ?, ?)";
    $stmt = mysqli_prepare($con, $sql);

    // Bind parameters
    mysqli_stmt_bind_param($stmt, 'sssssss', $payment_id, $payment_date, $card_name, $card_number, $expirydate, $cvv, $payment_total);
