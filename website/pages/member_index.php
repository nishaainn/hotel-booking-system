                            ...
                            <div class="booking-wrap d-flex justify-content-between align-items-center">
                                ...
                                <div class="single-select-box mb-30">
                                    ...
                                    <div class="boking-datepicker">
                                        <input id="datepicker1" placeholder="checkIn" name="checkin" />
                                    </div>
                                </div>
                                <!-- Single Select Box -->
                                <div class="single-select-box mb-30">
                                    ...
                                    <div class="boking-datepicker">
                                        <input id="datepicker2" placeholder="checkout" name="checkout" />
                                    </div>
                                </div>
                                ...
                                <div class="single-select-box mb-30">
                                    ...
                                    <div class="select-this">
                                        <div class="select-itms">
                                            <input type="text" id="adults" name="no_pax">
                                        </div>
                                    </div>
                                </div>
                                <!-- Single Select Box -->
                                ...
                                <div class="single-select-box pt-45 mb-30">
                                    <input type="hidden" name="purpose" value="availabilityMember" required>
                                    <button href="#" class="btn select-btn" type="submit">Book Now</>
                                </div>
