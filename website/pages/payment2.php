                    ...
                    <form action="../process/register.php" method="post">
                        ...
                        <div class="d-flex flex-column pb-3">
                            ...
                            <div class="inputWithIcon">
                                <input type="text" id="cardholder-name" name="payment_id" class="form-control"
                                    value="<?php echo $payment_id; ?>" readonly>
                        ...
                        <div class="d-flex flex-column pb-3">
                            ...
                            <div class="inputWithIcon">
                                <input type="text" id="cardholder-name" name="payment_total" class="form-control"
                                    value="RM<?php echo number_format($total_with_tax, 2); ?>" readonly>
                        ...
                        <div class="d-flex align-items-center pb-3">
                            <div class="d-flex flex-column pe-3">
                                ...
                                <input type="text" id="expiry-date" name="expireddate" class="form-control" required>
                            </div>
                            <div class="d-flex flex-column pe-3">
                        ...
                        <button type="submit" class="btn btn-primary mt-3">Pay
                            RM<?php echo number_format($total_with_tax, 2); ?></button>
                    </form>
                </div>
