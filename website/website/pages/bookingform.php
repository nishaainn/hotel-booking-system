...
// Generate a unique booking ID if not already set
if (!isset($_SESSION['booking_id'])) {
    $_SESSION['booking_id'] = 'B0' . str_pad(rand(0, 99999), 5, '0', STR_PAD_LEFT);
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt->bind_param("sssssiiss", $booking_id, $customer_id, $checkin, $checkout, $room_name, $no_pax, $no_day, $total, $request);

    if ($stmt->execute()) {
        $_SESSION['result'] = "Success!";
        $_SESSION['message'] = "Booking save successfully.";
