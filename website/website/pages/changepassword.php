...
<body>
    ...
    <div class="slider-area">
        <div class="single-slider hero-overly slider-height2 d-flex align-items-center"
            style="background-image: url('../assets/img/hero/password.jpg'); background-size: cover; width: 100%; height: 500px;">
            <div class="container">
                <div class="row ">
    ...
    <section class="contact-section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form class="form-contact contact_form" action="../process/update.php" method="post"
                        class="contact-form" novalidate="novalidate">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <input class="form-control valid" name="currentPassword" id="currentPassword"
                        ...
                        <div class="form-group mt-3">
                            <input type="hidden" name="email" value="<?php echo $user; ?>" required>
