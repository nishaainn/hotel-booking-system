        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Booking /</span> History Booking</h4>
              <div class="row">
                <div class="col-md-12">
                  <!-- Bordered Table -->
                  <div class="card">
                        ...
                        <table class="table table-bordered" id="bookingTable">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <div class="btn-group">
								  <a href="editbook.php" class="btn btn-warning">
									<i class="bx bx-edit-alt me-1"></i> Edit
								  </a>
								  <a href="viewbook.php" class="btn btn-dark">
